		...
		<div class="container-fluid">
        	...
        	<div class="row">
            	...
            	<div class="col-md-5">
            		...
            		sonra vakıf kullanıcısı harcamak isteklerini gör
            		harcama yapıldı olarak onayla desin, not eklesin, görsel varsa eklesin(fatura)
            		harcama kaydında gerekli düzeltmeyi varsa yapsın, o düzeltmeye göre para düşecek
            		
            		admin bakiyelerin güncellendiğini gördüğü zaman commitle
            		
            		istek gönderme bkbde
            		isteğin işlenmesi adminde ana sayfada görülecek 
            		tüm kullanıcılara bir de tüm olay kayıtlarını gör seçeneği ekle
