 ...
 */
@WebServlet(name = "AccountExistDauServlet", urlPatterns = {"/accountexistdau"})
public class AccountExistDauServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(httpSession.getAttribute("dau") == null) {
            ...
            dau = (DonationAcceptUnit) httpSession.getAttribute("dau");
